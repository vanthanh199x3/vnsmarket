                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>{{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('d/m/Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>{{ __('web.comment') }} ({{$post->allComments->count()}})</a></span>
                                    </div>
                            ...
                            <div class="col-12 mt-4">
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        <h2 class="reply-title">{{ __('web.leave_a_comment') }}</h2>
                                        <!-- Comment Form -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">{{ __('web.post_comment') }}</span><span class="comment_btn reply" style="display: none;">{{ __('web.reply_comment') }}</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-3">
                                {{ __('web.you_need_to') }} <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">{{ __('web.login') }}</a> {{ __('web.or') }} <a style="color:blue" href="{{route('register.form')}}">{{ __('web.register') }}</a> {{ __('web.for_comment') }}.
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">{{ __('web.comment') }} ({{$post->allComments->count()}})</h3>
                                    <!-- Single Comment -->
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter d-none">
                            <h3 class="title">{{ __('web.newslatter') }}</h3>
                            <div class="letter-inner">
                                ...
                                <form action="{{route('subscribe')}}" method="POST">
                                    ...
                                    <div class="form-inner">
                                        ...
                                        <button type="submit" class="btn mt-2">{{ __('web.submit') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
