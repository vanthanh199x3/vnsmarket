...
@section('main-content')
 ...
 <div class="card shadow mb-4 mx-2">
    ...
    <div class="card-header">
      {{ __('adm.banner_list') }}
      <a href="{{route('shop.page.create')}}" class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> {{ __('adm.add').' '.__('adm.page') }}</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($pages as $page)   
                <tr>
                    ...
                    <td>
                      <a href="{{route('shop.page.edit', $page->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%"><i class="fas fa-edit"></i></a>
                      <form method="POST" action="{{route('shop.page.destroy',[$page->id])}}">
                        @csrf 
                        @method('delete')
