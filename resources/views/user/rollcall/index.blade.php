                ...
                <div class="card-body">
                    <a class="text-light">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-center text-uppercase mb-1">{{ __('adm.total_rollcall') }}</div>
                                <div class="h5 mb-0 font-weight-bold text-center totalRollCall">{{ $total ?? 0 }}</div>
                            </div>
                        </div>
                    </a>
                </div>
