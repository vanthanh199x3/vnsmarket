...
@section('title', __('adm.post_tag_list'))
@section('main-content')
 ...
 <div class="card shadow mb-4 mx-2">
    ...
    <div class="card-header">
      {{ __('adm.post_tag_list') }}
      <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> {{ __('adm.add').' '.__('adm.post_tag') }}</a>
    </div>
    <div class="card-body">
