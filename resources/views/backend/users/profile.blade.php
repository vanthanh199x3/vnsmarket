...
<div class="card shadow mb-4 mx-2">
   ...
   <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-8">
                <form id="formProfile" class="border rounded px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input id="referrer" disabled name="referrer" placeholder="{{ __('adm.referrer_link') }}"  value="{{$profile->referrer}}" class="form-control">
                        @error('referrer')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
