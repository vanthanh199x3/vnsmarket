<div id="notifications">
    ...
    <a class="dropdown-item d-flex align-items-center" target="_blank" href="{{route('admin.notification',$notification->id)}}">
                ...
                <div>
                    <div class="small text-gray-500">{{$notification->created_at->format('d/m/Y H:i:s')}}</div>
        ...
        <a class="dropdown-item text-center small text-gray-500" href="{{route('all.notification')}}">{{ __('adm.notification_view_all') }}</a>
      </div>
</div>