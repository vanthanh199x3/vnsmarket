...
@section('title', __('adm.notification_list'))
...
<div class="card mx-2">
  ...
  <h5 class="card-header">{{ __('adm.notification_list') }}</h5>
  <div class="card-body">
    @if(count(Auth::user()->Notifications)>0)
    <div class="table-responsive">
      <table class="table table-sm table-hover admin-table" id="notification-dataTable">
        <thead class="thead-primary">
          <tr>
            <th scope="col">#</th>
            <th scope="col">{{ __('adm.notification_time') }}</th>
            <th scope="col">{{ __('adm.title') }}</th>
