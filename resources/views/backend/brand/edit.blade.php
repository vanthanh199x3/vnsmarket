...
@section('title', __('adm.edit') . ' ' . __('adm.brand'))
@section('main-content')

    <div class="card mx-2">
        <h5 class="card-header">{{ __('adm.edit') . ' ' . __('adm.brand') }}</h5>
        <div class="card-body">
            <form method="post" action="{{ route('brand.update', $brand->id) }}" id="formBrand">
                @csrf
                @method('PATCH')
