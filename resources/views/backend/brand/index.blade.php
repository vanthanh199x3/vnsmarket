...
@section('title', __('adm.brand_list'))
@section('main-content')
 ...
 <div class="card shadow mb-4 mx-2">
    ...
    <div class="card-header">
      {{ __('adm.brand_list') }}
      <a href="{{route('brand.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="{{ __('adm.add').' '.__('adm.brand') }}"><i class="fas fa-plus"></i> {{ __('adm.add').' '.__('adm.brand') }}</a>
    </div>
    <div class="card-body">
